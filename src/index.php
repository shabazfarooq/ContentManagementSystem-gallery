<?php
  ...
  if ($_REQUEST['action'] != "") {
    ...
    $sql = "UPDATE `home` SET `text` = '$text' WHERE `id`=0;";
    ...
    if(!$result = $con->query($sql)) {
      ...
      ?>
      <div align="center">
      <p><b>Home page updated</b><br><br></p>
      </div>
      <table width ="900px">
        <tr>
          <td width ="30px"> </td>
          <td width ="880px"><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $text; ?></p></td>
          <td width ="10px"> </td>
        </tr>
      </table>
      <?php
    ...
    while($row = $result->fetch_assoc()) {
      ...
      ?>
        ...
        <form  action="" method="POST" enctype="multipart/form-data">
          ...
          <input name="submit" type="submit" value="Update Home Page"/>
          <br><br>
          <textarea name="text" rows="50" cols="10" style="width: 870px" maxlength="16777215"/><?php echo $text; ?></textarea>
          <br><br>
          <input name="submit" type="submit" value="Update Home Page"/>
          </div>
        </form>
